...
type MediaTrack struct {
	...
	*MediaLossProxy
	...
	// AIC Protocol integration
	aicProcessor *AICProcessor
...
// SetAICProcessor sets the AIC processor for this track
...
// GetAICProcessor returns the AIC processor for this track
